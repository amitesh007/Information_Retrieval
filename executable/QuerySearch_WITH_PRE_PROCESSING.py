...
dictionary={}
input_file = csv.DictReader(open("inverted_index_file_with_pre_processing.csv"))
...
df.to_csv("output_test_file_with_pre_processed.csv", sep=',')
...
df1.to_csv("output_test_evaluation_with_pre_processed.csv", sep=',',index=False)
