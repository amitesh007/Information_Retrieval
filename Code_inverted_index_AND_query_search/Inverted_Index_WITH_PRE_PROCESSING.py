...
def invertedIndex():
    ...
    for doc in list_doc:
        ...
        file_text = with_preprocessing(file_text)
...
with open('inverted_index_file_with_pre_processing.csv', 'w') as f:
...
w = csv.writer(open("inverted_index_formated_file_with_pre_processing.csv", "w"))
